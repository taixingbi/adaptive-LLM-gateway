...
| Policy | Admit rate | Throttle rate | SLO attainment | p99 TTFT |
|---|---:|---:|---:|---:|
| `none` | 1.000 | 0.000 | ~0.999 | ~562 ms |
| `slo-aware` | 0.867 ± 0.023 | 0.133 ± 0.023 | 0.977 ± 0.003 | 394 ± 13 ms |
...
- Priority behavior matches design intent: P1 remains fully admitted while lower tiers absorb most throttling.

## Paper-ready Takeaway

Under the noisy-neighbor workload with a real Bedrock backend, the SLO-aware controller preserves high SLO attainment while significantly reducing tail latency for non-victim tenants. Relative to no admission control, it lowers p99 TTFT by roughly 30% at the cost of approximately 13% request shedding, with preferential protection for high-priority tenants.
